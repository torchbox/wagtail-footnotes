    ...
    componentDidMount() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var live_footnotes = document.querySelectorAll("#id_footnotes-FORMS > li:not(.deleted)");
                Array.prototype.forEach.call(live_footnotes, function(value){
                    ...
                    var row = $('<tr data-uuid='+uuid+'><td>'+text+'</td><td>'+uuid.substring(0,6)+'</td></tr>').css({"cursor":"pointer"});
                    table.append(row);
